...
func (txn *Transaction) AddToCall(pkg *decorator.Package, call *dst.CallExpr, transactionVariable string, async bool) {
...
func (txn *Transaction) AddToFuncDecl(pkg *decorator.Package, decl *dst.FuncDecl) {
...
func (txn *Transaction) AddToFuncLit(pkg *decorator.Package, lit *dst.FuncLit) {
...
func (txn *Transaction) AssignTransactionVariable(variableName string) dst.Stmt {
	// no-op
	return nil
}
